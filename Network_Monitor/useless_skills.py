...
def showcdp(message):
    showcdpoutput = cdp.show(cdp.get_shell(cdp.connect("192.168.56.102","22", "cisco", "cisco123!")),"show cdp neighbor")
    cdp.close(cdp.connect("192.168.56.102","22", "cisco", "cisco123!"))
    return showcdpoutput
