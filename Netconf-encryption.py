...
netconf_reply2 = m.edit_config(target="running", config=netconf_password_encryption)
print(xml.dom.minidom.parseString(netconf_reply2.xml).toprettyxml())

netconf_reply3 = n.edit_config(target="running", config=netconf_password_encryption)
print(xml.dom.minidom.parseString(netconf_reply3.xml).toprettyxml())
